PRCST2 ; GENERATED FROM 'PRCSENR&NRS' INPUT TEMPLATE(#616), FILE 410;09/19/10
 D DE G BEGIN
...
30 S DQ=31 ;@1
31 S D=0 K DE(1) ;10
 S DIFLD=10,DGO="^PRCST21",DC="24^410.02AI^IT^",DV="410.02MRNJ3,0",DW="0;1",DOW="LINE ITEM NUMBER",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
