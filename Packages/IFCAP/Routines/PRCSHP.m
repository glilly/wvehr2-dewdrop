PRCSHP ; GENERATED FROM 'PRCS CP ITEMHIST' PRINT TEMPLATE (#1190) ; 09/19/10 ; (FILE 410, MARGIN=80)
 G BEGIN
N W !
...
A1 ;
 ...
 D N:$X>34 Q:'DN  W ?34 S Y=$P(X,U,3) S Y=$S(Y="":Y,$D(^PRCD(420.5,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,2)
