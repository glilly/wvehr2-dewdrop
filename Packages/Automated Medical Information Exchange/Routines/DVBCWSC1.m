DVBCWSC1 ;ALB/CMM INFEC, IMM, NUTRITIONSL DIS WKS TEXT - 1 ; 6 MARCH 1997
...
TXT ;
 ...
 ;;
 ;;
 ;;    5.  Disease activity (exacerbations and/or remissions)?  If there
 ;;        were exacerbations, what was the state of the veteran's health
 ;;        between exacerbations?  Frequency and duration of exacerbations.
 ;;
 ;;
 ;;    6.  Current symptoms.
 ;;
