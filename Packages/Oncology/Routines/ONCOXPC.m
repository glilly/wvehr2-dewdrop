ONCOXPC ; GENERATED FROM 'ONCO XPATIENT CONTACTS' PRINT TEMPLATE (#807) ; 09/19/10 ; (FILE 160, MARGIN=80)
 G BEGIN
N W !
...
A1 ;
 ...
 D N:$X>41 Q:'DN  W ?41 S Y=$P(X,U,2) S Y=$S(Y="":Y,$D(^ONCO(165,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
 Q
A1R ;
 K Y
 Q
