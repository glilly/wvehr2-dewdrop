LRBLDPK ; GENERATED FROM 'LRBL DONOR TESTING SUPPLEMENT' PRINT TEMPLATE (#112) ; 09/19/10 ; (FILE 65.5, MARGIN=132)
 G BEGIN
N W !
...
B1 ;
 ...
 G A2R
A2 ;
 S X=$G(^LRE(D0,5,D1,66,D2,0)) D N:$X>87 Q:'DN  W ?87 S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^LAB(66,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,15)
