ONCTXSM ;Hines OIFO/GWB - TREATMENT SUMMARY SCREEN;10/14/98
 ;;2.11;ONCOLOGY;**19,26,27,32,34,36,37**;Mar 07, 1995
 D CHECKCC
 D DEFAULT
 N DI,DIC,DR,DA,DIQ S SAVEY=Y K ONC
 ...
 Q
 ;
CHECKCC ;Check the class of case - if 0,3,6 stuff @FAC fields with zeroes
