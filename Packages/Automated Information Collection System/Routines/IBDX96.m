IBDX96 ; GENERATED FROM 'IBD CREATE FORM TRACKING' INPUT TEMPLATE(#1477), FILE 357.96;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="IBDX96",DQ=1
 ...
 M DIEZAR=^DIE(1477,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1477,U="^"
