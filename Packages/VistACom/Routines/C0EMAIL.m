C0EMAIL ;FWSLC/DLW-EWD/Mail generator; 9/13/12 2:29am
        ;;0.1;EWD UTILS;****LOCL RTN**;;Build 7
        ;
        ...
        ;
        ; $Source: endor:/home/dlw/vistacom/kids/C0E_VISTACOM_1P0.KID $
        ; $Revision: [0:733a234b83bc] 2012-10-06 15:51 -0600 $
        ;
...
MAIL(sessid)    ;Display the mail message body
        ...
        ;
        N NUM S NUM=$$parseContents^C0EMPAR(MSGNUM,.META)
        ;
        S BODY(1)="<pre>"
        N N,I,M S (N,M)=0,I=2
...
DISPLAY(sessid) ;Display the CCR/CCD attachment
        ...
        N NUM S NUM=$$parseContents^C0EMPAR(MSGNUM,.META,"NXML")
