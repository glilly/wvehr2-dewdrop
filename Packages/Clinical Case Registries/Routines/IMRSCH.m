IMRSCH ;ISC-SF/JLI,HCIOFO/FT-OUTPATIENT ACTIVITY ;01/14/02 11:10 ;
 ;;2.1;IMMUNOLOGY CASE REGISTRY;**16,15**;Feb 09, 1998
 ;
...
OP0 K IMRAR,IMROPI
 ...
 .. S IMRC=IMRC+1,^TMP($J,"IMRX",IMRC)="OP"_"^"_IMRDESIG_"^"_IMRIX_"^"_IMRSJ_"^"_$P(^TMP($J,"IMROP",IMRIX,IMRSJ,IMRCNT2),U,2) D LCHK^IMRDAT
 .S IMRSEND=1
 .Q
 G EXIT
 Q
OP2 ; SET ^TMP FOR SEPERATE ENCOUNTERS
...
ACRP ; Ambulatory Care Reporting Project changes
 ...
 D SCANCB^SDQ(.QUERY,"D SCAN^IMRSCH(Y,Y0)","SET")
