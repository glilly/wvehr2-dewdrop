XPDI ;SFISC/RSD - Install Process ;9:53 AM  31 Jan 2008
...
EN ;install
 ...
 ;;
 ;; Patch checker , points to file # 9.6  ; RED
 D EN^VEPEFKPC(.XPDT,.XPDQUIT,1053) Q:$D(XPDQUIT)    ;VOE 1 Patch
 D EN^VEPEFKPC(.XPDT,.XPDQUIT,1054) Q:$D(XPDQUIT)    ;VOE 1.1 Patch
 D EN^VEPEFKPC(.XPDT,.XPDQUIT,7397) Q:$D(XPDQUIT)    ;NO HOME 1.0 Patch
 ;
