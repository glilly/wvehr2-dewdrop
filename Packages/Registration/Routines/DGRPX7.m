DGRPX7 ; GENERATED FROM 'DG LOAD EDIT SCREEN 7' INPUT TEMPLATE(#420), FILE 2;09/20/12
 D DE G BEGIN
...
X18 S:'X Y=.313
 Q
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW=".29;2",DV="D",DU="",DLB="DATE RULED INCOMPETENT (CIVIL)",DIFLD=.292
 G RE
X19 S %DT="E" D ^%DT S X=Y K:Y<1 X
 Q
 ;
20 S DW=".29;1",DV="D",DU="",DLB="DATE RULED INCOMPETENT (VA)",DIFLD=.291
 G RE
X20 S %DT="E" D ^%DT S X=Y K:Y<1 X
 Q
 ;
