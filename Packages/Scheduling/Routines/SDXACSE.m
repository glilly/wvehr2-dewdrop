SDXACSE ; GENERATED FROM 'SDXACSE' INPUT TEMPLATE(#490), FILE 409.5;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="SDXACSE",DQ=1
 ...
 M DIEZAR=^DIE(490,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=490,U="^"
