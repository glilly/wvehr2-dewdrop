DVBAXA ; GENERATED FROM 'DVBA C ADD 2507 PAT' INPUT TEMPLATE(#965), FILE 2;09/25/12
 D DE G BEGIN
...
C5F1 N X,X1,X2 S DIXR=739 D C5X1(U) K X2 M X2=X D C5X1("O") K X1 M X1=X
 D
...
C13S S X="" G:DG(DQ)=X C13F1 K DB
 D ^DVBAXA4
C13F1 N X,X1,X2 S DIXR=743 D C13X1(U) K X2 M X2=X D C13X1("O") K X1 M X1=X
 D
