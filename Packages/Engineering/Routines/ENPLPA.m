ENPLPA ; GENERATED FROM 'ENPLP008' PRINT TEMPLATE (#161) ; 09/19/10 ; (FILE 6925, MARGIN=132)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>44 Q:'DN  W ?44 X ^DD(6925,218.1,9.4) S X=X+999.999\1000*1000 S X=$J(X,0,0) W:X'?."*" $J(X,11,0) K Y(6925,218.1)
