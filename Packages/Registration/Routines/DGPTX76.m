...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=457 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X10(DION) K X
 ...
 S X=$G(X(1))
 Q
11 N X,X1,X2 S DIXR=458 D X11(U) K X2 M X2=X D X11("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X11(DION) K X
 ...
 S X=$G(X(1))
 Q
12 N X,X1,X2 S DIXR=459 D X12(U) K X2 M X2=X D X12("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
