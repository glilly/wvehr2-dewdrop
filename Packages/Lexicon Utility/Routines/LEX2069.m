LEX2069 ;ISL/KER - LEX*2.0*69 Env Check ;02/03/2010
...
IMP ;   Import names
 ...
 S LEXLREV=69
 ;     Required Builds
 ; LEX 55 SEP  2,2009  LEX 68 JAN  8,2010
 S LEXREQP="LEX*2.0*55^3090902;LEX*2.0*68^3100108"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*69"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_69.GBL"
 ;     Fiscal Year
 S LEXFY="FY10"
 ;     Quarter
 S LEXQTR="3rd"
