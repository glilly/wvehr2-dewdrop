RTCM ; GENERATED FROM 'RT MOVEMENT' INPUT TEMPLATE(#884), FILE 190.3;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="RTCM",DQ=1
 ...
 M DIEZAR=^DIE(884,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=884,U="^"
