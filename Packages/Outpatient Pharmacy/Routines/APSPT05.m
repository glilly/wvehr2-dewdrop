APSPT05 ; GENERATED FROM 'PSO INTERVENTION NEW' INPUT TEMPLATE(#870), FILE 9009032.4;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="APSPT05",DQ=1
 ...
 M DIEZAR=^DIE(870,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=870,U="^"
