IMRODLAB ;HCIOFO/SPS/FAI - LABORATORY DATA EXTRACT; 03/09/02  12:33
...
CHK ; Called from IMRODAT1 routine
 ...
 F I=1:1:$S($G(IMRTRANS)=1:7,1:2) S IMRRTYP=$P(IMRLABTR,U,I) Q:IMRRTYP=""  D LAB^IMRODLAB(IMRRFN,IMRRTYP,IMRSD,IMRED)
 Q
 ;
