PSBCSUTL ;BIRMINGHAM/TEJ- BCMA-HSC COVER SHEET UTILITIES ;4:37 PM  6 Mar 2012
 ;;3.0;BAR CODE MED ADMIN;**16,13,38,32,50,LOCAL**;Mar 2004;Build 78
...
PAINCMT(DFN) ;;Add comment if Pain Score entered in BCMA was marked "Entered in Error" in Vitals.
 ...
 .....;was;I PSBTMDF>=-($S($G(DILOCKTM)>0:DILOCKTM,1:3)),PSBTMDF<=$S($G(DILOCKTM)>0:DILOCKTM,1:3) D
