DGMTXN ; GENERATED FROM 'DGMT ENTER/EDIT NET WORTH' INPUT TEMPLATE(#476), FILE 408.21;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="DGMTXN",DQ=1
 ...
 M DIEZAR=^DIE(476,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=476,U="^"
