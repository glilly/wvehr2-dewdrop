MCAROGE ; GENERATED FROM 'MCGENERICPRINT' PRINT TEMPLATE (#1018) ; 09/19/10 ; (FILE 699.5, MARGIN=80)
 G BEGIN
N W !
...
A1R ;
 ...
 G B1R
B1 ;
 S X=$G(^MCAR(699.5,D0,4,D1,0)) D N:$X>19 Q:'DN  W ?19 S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^PSDRUG(Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
 Q
B1R ;
