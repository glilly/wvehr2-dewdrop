IBXEXI ; GENERATED FROM 'IB INACTIVATE EXEMPTION' INPUT TEMPLATE(#518), FILE 354.1;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="IBXEXI",DQ=1
 ...
 M DIEZAR=^DIE(518,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=518,U="^"
