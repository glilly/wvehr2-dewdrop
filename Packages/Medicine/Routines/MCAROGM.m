MCAROGM ; GENERATED FROM 'MCAROGM' PRINT TEMPLATE (#1013) ; 09/19/10 ; (FILE 699, MARGIN=80)
 G BEGIN
N W !
...
A1R ;
 ...
 G B1R
B1 ;
 S X=$G(^MCAR(699,D0,8,D1,0)) D N:$X>21 Q:'DN  W ?21 S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^MCAR(695,Y,0))#2:$P(^(0),U),1:Y) S Y=$S(Y="":Y,$D(^PSDRUG(Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
 W "  "
