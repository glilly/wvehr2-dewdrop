MCAROC1 ; GENERATED FROM 'MCARCATH1' PRINT TEMPLATE (#974) ; 09/19/10 ; (FILE 691.1, MARGIN=80)
 G BEGIN
N W !
...
D1R ;
 ...
 G E1R
E1 ;
 S X=$G(^MCAR(691.1,D0,6,D1,0)) W ?17 S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^MCAR(695,Y,0))#2:$P(^(0),U),1:Y) S Y=$S(Y="":Y,$D(^PSDRUG(Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
