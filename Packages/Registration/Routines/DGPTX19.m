...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW=".52;5",DV="RSX",DU="",DLB="POW STATUS INDICATED?",DIFLD=.525
 S DE(DW)="C1^DGPTX19",DE(DW,"INDEX")=1
...
X2 S:X'="Y" Y="@42"
 Q
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".52;6",DV="RP22'X",DU="",DLB="POW CONFINEMENT LOCATION",DIFLD=.526
 S DE(DW)="C3^DGPTX19"
 S DU="DIC(22,"
 G RE
...
C3S S X="" G:DG(DQ)=X C3F1 K DB
 ...
 D EVENT^IVMPLOG(DA)
C3F1 Q
X3 S DFN=DA,DGCOMLOC=X D POW^DGLOCK
 Q
 ;
4 S DQ=5 ;@42
