APSPT16 ; GENERATED FROM 'PSO INTERVENTIONS' PRINT TEMPLATE (#468) ; 09/19/10 ; (FILE 9009032.4, MARGIN=80)
 G BEGIN
CP G CP^DIO2
C S DQ(C)=Y
...
BEGIN ;
 ...
 D N:$X>6 Q:'DN  W ?6 S Y=$P(X,U,5) S Y=$S(Y="":Y,$D(^PSDRUG(Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
