IBXS8I ; GENERATED FROM 'IB SCREEN82' INPUT TEMPLATE(#577), FILE 399;08/30/12
 D DE G BEGIN
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 ...
 I $D(^("U3")) S %Z=^("U3") S %=$P(%Z,U,3) S:%]"" DE(34)=%
