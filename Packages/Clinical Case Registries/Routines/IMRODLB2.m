IMRODLB2 ;HOIFO/SPS/FAI-MICROBIOLOGY DATA EXTRACT;03/09/02  11:14 ;
 ;;2.1;IMMUNOLOGY CASE REGISTRY;**15**;Feb 09, 1998
 ; Called from IMRODLAB routine
BAC ;
...
PAR ;
 ...
 ...S IMRRX1=$G(IMRPARN)_U_"PAR"_U_$G(IMRRX2)_U_$G(IMRRX3)_U_$G(IMRRX4)
 ...D BKLN
 Q
PARRPT ; Report
 ...
 .Q:IMRRX2=""
 .S IMRRX1="PARRPT"_U_$G(IMRRX2)
 .D BKLN
 Q
COMSP ;Comment on Specimen
 S IMRRX1=$G(^LR(IMRRFN,IMRRTYP,IMRRD,IMRX))
 Q:IMRRX1=""
 S IMRRX1=99_U_$G(IMRRX1)
 D BKLN
 Q
 Q
BKLN ; Break Line
 S IMRC=IMRC+1,^TMP($J,"IMRX",IMRC)=$G(IMRRX)_U_$G(IMRRX1),IMRRX1=$P(IMRRX1,U,1,2)_U_($P(IMRRX1,U,3)+1) S IMRSEND=1 D LCHK^IMRODATA
 Q
