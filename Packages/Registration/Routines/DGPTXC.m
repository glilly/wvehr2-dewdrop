DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#443), FILE 45;09/19/10
 D DE G BEGIN
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=447,448,449,450,451,452,453,454,455,456,457,458,459,460,461 S DIEZRXR(45,DIXR)=""
 Q
X1 Q
