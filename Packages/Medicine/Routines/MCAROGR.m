MCAROGR ; GENERATED FROM 'MCARGIRCLI' PRINT TEMPLATE (#981) ; 09/19/10 ; (FILE 699, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 I $D(DXS)<9 M DXS=^DIPT(981,"DXS")
 S I(0)="^MCAR(699,",J(0)=699
 D T Q:'DN  D N W ?0 W "Proc: "
 S X=$G(^MCAR(699,D0,0)) S Y=$P(X,U,12) S Y=$S(Y="":Y,$D(^MCAR(697.2,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,20)
