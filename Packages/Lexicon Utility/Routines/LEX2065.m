LEX2065 ;ISL/KER - LEX*2.0*65 Env Check ;06/06/2007
 ...
 ;              
ENV ; LEX*2.0*65 Environment Check
 ;                    
 ;   General
 ;
...
ABRT ;     Abort  Failed Environment Check, KILL the distribution
 D:$D(LEXE) ED S XPDABORT=1,XPDQUIT=1,XPDQUIT("LEX*2.0*65")=1
 K LEXE,LEXFULL
 Q
 ;               
 ; Checks
...
IMP ;   Import names
 ...
 S LEXLREV=65
 ;     Required Builds
 S LEXREQP="LEX*2.0*63"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*65"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_65.GBL"
 ;     Fiscal Year
 S LEXFY="FY09"
 ;     Quarter
 S LEXQTR="3rd"
