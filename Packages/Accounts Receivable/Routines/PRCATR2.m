PRCATR2 ; GENERATED FROM 'PRCAA AMEND AUDIT' PRINT TEMPLATE (#417) ; 09/19/10 ; (FILE 430, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 S X=$G(^PRCA(430,D0,0)) D N:$X>44 Q:'DN  W ?44 S Y=$P(X,U,2) S Y=$S(Y="":Y,$D(^PRCA(430.2,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
