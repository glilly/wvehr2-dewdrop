SDAMXOE ; GENERATED FROM 'SD ENCOUNTER ENTRY' INPUT TEMPLATE(#493), FILE 409.68;09/19/10
 D DE G BEGIN
...
BEGIN S DNM="SDAMXOE",DQ=1
 ...
 M DIEZAR=^DIE(493,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=493,U="^"
