ZPSSDOSE ;BIR/RTR-Dosage review report ; 8/16/05 4:14pm
...
PASS ;
 ...
 ..W !!!,$G(PSSNAME)_U
 ..I ($Y+5)>IOSL D HD Q:$G(PSSOUT)
 ..I $G(PSSMSG)'="" W $G(PSSMSG)_U
 ..I '$O(^PSDRUG(PSSIEN,"DOS1",0)),'$O(^PSDRUG(PSSIEN,"DOS2",0)) Q
 ..I ($Y+5)>IOSL D HD Q:$G(PSSOUT)
 ..W "Strength: "_$S($E($G(PSSSTR),1)=".":"0",1:"")_$G(PSSSTR)_U W "Units: " I $G(PSSUNIT)'="",$G(PSSUNIT)'["/" W $G(PSSUNIT)_U
 ..I $G(PSSUNIT)'="",$G(PSSUNIT)'["/",$L(PSSUNIT)>15
 ..W "Application Package: "_$G(PSSAPU)_U
 ..I ($Y+5)>IOSL D HD Q:$G(PSSOUT)
 ..S PSSA=0 K PSSC,PSSD,PSSE W "Possible Dosages: " I $G(PSSSTR)'="",$G(PSSUNIT)'="" D
 ...
 ....I ($Y+5)>IOSL D HD Q:$G(PSSOUT)
 ....W "Dispense Units Per Dose: "_$S($E($G(PSSC),1)=".":"0",1:"")_$G(PSSC)_U_"Dose: " D
 .....I $G(PSSUNIT)'["/" W $S($E($G(PSSD),1)=".":"0",1:"")_$G(PSSD)_$G(PSSUNIT) W U_"Package: "_$G(PSSE)_U D OUT Q
 .....D SETD D ZERO W $G(PSSCALC)_U_"Package: "_$G(PSSE) D OUT
 ..Q:$G(PSSOUT)
 ..I 'PSSA W "(None)"_U
 ..S PSSA=0 W !,"Local Possible Dosages: " F PSSB=0:0 S PSSB=$O(^PSDRUG(PSSIEN,"DOS2",PSSB)) Q:'PSSB!($G(PSSOUT))  D
 ...I $P($G(^PSDRUG(PSSIEN,"DOS2",PSSB,0)),"^")'="" S PSSA=1 D
 ....I ($Y+5)>IOSL D HD Q:$G(PSSOUT)
 ....W $P($G(^PSDRUG(PSSIEN,"DOS2",PSSB,0)),"^")_U_"Package: "_$P($G(^(0)),"^",2)
 ..I 'PSSA W "(None)"_U
END ;
