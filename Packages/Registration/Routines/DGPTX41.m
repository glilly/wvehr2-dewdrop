...
DE S DIE="^DGPT(D0,""S"",",DIC=DIE,DP=45.01,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"S",DA,""))=""
 ...
 I  S %=$P(%Z,U,9) S:%]"" DE(20)=% S %=$P(%Z,U,10) S:%]"" DE(25)=% S %=$P(%Z,U,11) S:%]"" DE(30)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
C5F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=437,438,439,440,441 S DIEZRXR(45.01,DIXR)=""
 Q
...
C15F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=437 S DIEZRXR(45.01,DIXR)=""
 Q
...
C20F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=438 S DIEZRXR(45.01,DIXR)=""
 Q
...
C25F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=439 S DIEZRXR(45.01,DIXR)=""
 Q
...
C30F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=440 S DIEZRXR(45.01,DIXR)=""
 Q
