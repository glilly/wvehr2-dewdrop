LEX2067 ;ISL/KER - LEX*2.0*67 Env Check ;06/03/2009
 ;;2.0;LEXICON UTILITY;**67**;Sep 23, 1996;Build 4
 ;              
 ; Variables KILLed by Kernel Installation
 ; and Distribution System (KIDS)
 ;              
 ;    XPDABORT
 ;    XPDDIQ("XPI1") and XPDDIQ("XPZ1")
 ;    XPDENV
 ;    XPDQUIT
 ;              
 ; Global Variables
...
IMP ;   Import names
 ...
 S LEXLREV=67
 ;     Required Builds
 S LEXREQP="ICD*18.0*34;ICD*18.0*39;LEX*2.0*66"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*67"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_67.GBL"
 ;     Fiscal Year
 S LEXFY="FY09"
 ;     Quarter
 S LEXQTR="4th"
