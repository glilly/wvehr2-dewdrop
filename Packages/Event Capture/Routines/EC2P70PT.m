...
ENTUP ;
 ...
 D ADDPROC^EC725U28  ;add new procedures
 D NAMECHG^EC725U28  ;change desription
 D CPTCHG^EC725U29   ;change CPT code
 D INACT^EC725U29   ;inactivate code
 D REACT^EC725U29    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*70"
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*70 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P70PT",ZTDESC="File #720.3 Review from EC*2*70",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P70",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
