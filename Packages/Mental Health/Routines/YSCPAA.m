YSCPAA ; GENERATED FROM 'YSJOB' PRINT TEMPLATE (#551) ; 09/19/10 ; (FILE 624, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>32 Q:'DN  W ?32 S Y=$P(X,U,9) S Y=$S(Y="":Y,$D(^DIC(5,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
