...
20 D:$D(DG)>9 F^DIE17,DE S DQ=20,D=0 K DE(1) ;42
 S DIFLD=42,DGO="^IBXSC75",DC="15^399.042IPA^RC^",DV="399.042MR*P399.2'",DW="0;1",DOW="REVENUE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.2,"
