DGPMX2 ; GENERATED FROM 'DGPM TRANSFER' INPUT TEMPLATE(#447), FILE 405;09/19/10
 D DE G BEGIN
DE S DIE="^DGPM(",DIC=DIE,DP=405,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGPM(DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,1) S:%]"" DE(2)=% S %=$P(%Z,U,4) S:%]"" DE(6)=% S %=$P(%Z,U,6) S:%]"" DE(10)=% S %=$P(%Z,U,7) S:%]"" DE(13)=%,DE(17)=%,DE(21)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
