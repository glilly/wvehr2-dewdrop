IBXSC5 ; GENERATED FROM 'IB SCREEN5' INPUT TEMPLATE(#511), FILE 399;09/19/10
 D DE G BEGIN
...
X2 S:$D(IBOUT) Y="@999"
 Q
3 S D=0 K DE(1) ;43
 S DIFLD=43,DGO="^IBXSC51",DC="1^399.043DA^OP^",DV="399.043MDX",DW="0;1",DOW="OP VISITS DATE(S)",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
...
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,D=0 K DE(1) ;41
 S DIFLD=41,DGO="^IBXSC52",DC="4^399.041IPA^OC^",DV="399.041M*P399.1'",DW="0;1",DOW="OCCURRENCE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X17 S:IBDR20'["58" Y="@54"
 Q
18 S D=0 K DE(1) ;40
 S DIFLD=40,DGO="^IBXSC53",DC="1^399.04PA^CC^",DV="399.04M*P399.1'",DW="0;1",DOW="CONDITION CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X26 I $P(^DGCR(399,DA,0),U,19)=2 S Y="@999"
 Q
27 S D=0 K DE(1) ;47
 S DIFLD=47,DGO="^IBXSC54",DC="2^399.047PA^CV^",DV="399.047M*P399.1'X",DW="0;1",DOW="VALUE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
